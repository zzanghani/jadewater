...
export default function MonthlySalesChart({ data }: { data: MonthlyPoint[] }) {
    ...
    <div className="h-56 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 8, right: 8, left: -12, bottom: 0 }}>
          ...
          />
          <Bar dataKey="food" stackId="s" fill="var(--brand-dark)" barSize={10} />
          <Bar dataKey="beverage" stackId="s" fill="var(--brand)" barSize={10} />
          <Bar
            dataKey="wine"
            stackId="s"
